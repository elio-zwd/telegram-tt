...
"ContinuousMediaSettings" = "Continuous media browsing";
"ContinuousMediaDefault" = "Enable by default in channels";
"ContinuousMediaBrowse" = "Continuous browsing";
"ContinuousMediaPause" = "Pause continuous browsing";
"ContinuousMediaResume" = "Resume continuous browsing";
"ContinuousMediaPosition" = "{position} / {total}";
"ContinuousMediaFilter" = "Media type";
"ContinuousMediaFilterAll" = "Photos and videos";
"ContinuousMediaFilterPhotos" = "Photos only";
"ContinuousMediaFilterVideos" = "Videos only";
"ContinuousMediaPhotoDuration" = "Photo duration";
"ContinuousMediaAutoSave" = "Auto-save while browsing";
"ContinuousMediaAutoSavePhotos" = "Auto-save photos";
"ContinuousMediaAutoSaveVideos" = "Auto-save videos";
"ContinuousMediaAutoSaveMaxSize" = "Maximum file size";
"ContinuousMediaFinished" = "All media viewed";
"ContinuousMediaUnviewedOnly" = "Only browse unviewed media";
"ContinuousMediaClearViewHistory" = "Clear media view history";
"ContinuousMediaClearViewHistoryDescription" = "Forget which channel media you have viewed on this account";
"ContinuousMediaViewHistoryCleared" = "Media view history cleared";
"ResumeMediaPosition" = "Continue from last media";
"GifsTab2" = "GIFs";
...
`;export{e as default};
//# sourceMappingURL=fallback-HsEf120V.js.map